...
Download_brook(){
	...
	cd ${file}
	if [[ ${bit} == "x86_64" ]]; then
		wget --no-check-certificate -N "https://github.com/keybook1/keybook/releases/download/v20200801/brook"
	else
		wget --no-check-certificate -N "https://github.com/keybook1/keybook/releases/download/v20200801/brook_linux_386"
